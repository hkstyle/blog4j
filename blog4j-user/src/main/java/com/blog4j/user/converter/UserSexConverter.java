...
public class UserSexConverter implements Converter<Integer> {
    ...
    public WriteCellData<?> convertToExcelData(WriteConverterContext<Integer> context) {
        ...
        if (Objects.equals(value, 0)) {
            return new WriteCellData<>(UserSexEnum.MAN.getDesc());
        }
        if (Objects.equals(value, 1)) {
            return new WriteCellData<>(UserSexEnum.WOMAN.getDesc());
        }
        return new WriteCellData<>(UserSexEnum.SECRET.getDesc());
    }
}
