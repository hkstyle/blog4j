 ...
 **/
public class OrganizationStatusConverter implements Converter<Integer> {
    @Override
    ...
    public WriteCellData<?> convertToExcelData(WriteConverterContext<Integer> context) {
        ...
        if (Objects.equals(value, 1)) {
            return new WriteCellData<>(OrganizationStatusEnum.NORMAL.getDesc());
        }
        if (Objects.equals(value, 2)) {
            return new WriteCellData<>(OrganizationStatusEnum.LOCK.getDesc());
        }
        return new WriteCellData<>(OrganizationStatusEnum.NORMAL.getDesc());
    }
}
